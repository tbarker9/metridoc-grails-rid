            ...
            <div id="show-ridCourseSponsor" class="content scaffold-show" role="main">
                ...
                <ol class="property-list ridCourseSponsor">
                    ...
                    <li class="fieldcontain">
                        <span id="name-label" class="property-label"><g:message code="ridCourseSponsor.name.label" default="Name" /></span>
                        
                            <span class="property-value" aria-labelledby="name-label"><g:fieldValue bean="${ridCourseSponsorInstance}" field="name"/></span>
                    ...
                    <li class="fieldcontain">
                        <span id="inForm-label" class="property-label"><g:message code="ridCourseSponsor.inForm.label" default="In Form" /></span>
                        
                            <span class="property-value" aria-labelledby="inForm-label"><g:fieldValue bean="${ridCourseSponsorInstance}" field="inForm"/></span>
                ...
                <g:form>
                    <fieldset class="buttons">
                        ...
                        <g:actionSubmit class="btn btn-success" action="edit" id="${ridCourseSponsorInstance?.id}" value="${message(code: 'default.button.edit.label', default: 'Edit')}" />
