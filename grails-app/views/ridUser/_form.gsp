...
<div class="control-group fieldcontain">
    ...
    <div class="controls">
	    <g:textField class="userInput" name="name" value="${ridUserInstance?.name}"/>
    </div>
</div>
...
<div class="control-group fieldcontain">
    ...
    <div class="controls">
        ...
        <g:select name="inForm" from="${choices}" value="${ridUserInstance?.inForm}" keys="${ridUserInstance.constraints.inForm.inList}" />
    </div>
</div>
