    ...
    <div class="span3">
        <div class="fieldcontain ${hasErrors(bean: ridTransactionInstance, field: 'sequenceName', 'error')} ">
            <label for="sequenceName">
                <g:message code="ridTransaction.sequenceName.label" default="Instructional Sequence Name"/>
...
<div class="row-fluid">
    ...
    <div class="span2">
        <div class="fieldcontain ${hasErrors(bean: ridTransactionInstance, field: 'department', 'error')}">
            <label for="department">
                ...
                <a style="font-size: 14px" data-toggle="modal" data-department="department"
    ...
    <div class="span2">
        <div class="fieldcontain ${hasErrors(bean: ridTransactionInstance, field: 'extraDepartments', 'error')}">
            <label for="extraDepartment1">
                <g:message code="ridTransaction.extraDepartments.label" default="Cross-Listed Department"/>
                <a style="font-size: 14px" data-toggle="modal" data-department="extraDepartment1"
                   href="../ridAdminDepartment/departmentList" data-target="#myDepartment">
                    <i class="icon-file-alt"></i>
                </a>
            </label>
            <g:select style="width:120px" id="extraDepartment1" name="extraDepartment1.id"
                      from="${metridoc.rid.RidDepartment.list().sort { it.name }}" optionKey="id"
                      class="many-to-one"/>
        </div>
    </div>
    ...
    <div class="span2">
        <div class="fieldcontain ${hasErrors(bean: ridTransactionInstance, field: 'extraDepartments', 'error')}">
            <label for="extraDepartment2">
                <g:message code="ridTransaction.extraDepartments.label" default="Cross-Listed Department"/>
                <a style="font-size: 14px" data-toggle="modal" data-department="extraDepartment2"
                   href="../ridAdminDepartment/departmentList" data-target="#myDepartment">
                    <i class="icon-file-alt"></i>
                </a>
            </label>
            <g:select style="width:120px" id="extraDepartment2" name="extraDepartment2.id"
                      from="${metridoc.rid.RidDepartment.list().sort { it.name }}" optionKey="id"
                      class="many-to-one"/>
        </div>
    </div>
...
<div class="row-fluid">
    <div class="span2">
        <div class="fieldcontain ${hasErrors(bean: ridTransactionInstance, field: 'sessionType', 'error')} required">
            ...
            <%
                def typeList = metridoc.rid.RidSessionType.findAllByInFormAndRidLibraryUnit(1,
    ...
    <div class="span2">
        <div class="fieldcontain ${hasErrors(bean: ridTransactionInstance, field: 'instructionalMaterials', 'error')} required">
            ...
            <%
                def instructionalMaterialsList = RidInstructionalMaterials.findAllByInForm(1)
        ...
        <div class="span2">
            <div class="fieldcontain ${hasErrors(bean: ridTransactionInstance, field: 'audience', 'error')} required">
                ...
                <%
                    def audienceList = RidAudience.findAllByInForm(1)
