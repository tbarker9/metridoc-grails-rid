            ...
            <div id="list-ridServiceProvided" class="content scaffold-list" role="main">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        ...
                        <g:sortableColumn property="name" title="${message(code: 'ridServiceProvided.name.label', default: 'Name')}" />
                    ...
                    <g:each in="${ridServiceProvidedInstanceList}" status="i" var="ridServiceProvidedInstance">
                        <tr>
                            ...
                            <td>${fieldValue(bean: ridServiceProvidedInstance, field: "inForm")}</td>
